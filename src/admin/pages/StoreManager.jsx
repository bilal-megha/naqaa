    ...
    <div>
      ...
      <div style={S.card}>
        ...
        <div style={S.grid2}>
          ...
          <div>
            ...
            {storeLogo && (
              <LazyImage src={storeLogo} width={60} height={60} radius={8} fallback="🖼️" />
            )}
          </div>
        </div>
        <button style={{ ...S.btn, marginTop: 14 }} onClick={saveTexts} disabled={saving}>
      ...
      <div style={S.card}>
        ...
        <div style={S.grid2}>
          ...
          {form.image && (
            <div>
              <LazyImage src={form.image} width={60} height={60} radius={8} fallback="🖼️" />
            </div>
          )}
        </div>
        ...
        <div style={S.card}>
          ...
          {banners.map((b, i) => (
            ...
            >
              ...
              {b.image && (
                <LazyImage src={b.image} width={60} height={60} radius={8} fallback="🖼️" />
              )}
              <div style={{ flex: 1 }}>
