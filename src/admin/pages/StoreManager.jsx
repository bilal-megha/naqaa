/**
 * @file pages/StoreManager.jsx
 * @description إدارة واجهة المتجر — هوية بصرية، بانرات، نصوص ترويجية
 */
      ...
      <div style={S.card}>
        ...
        <div style={S.grid2}>
          ...
          <div>
            ...
            {storeLogo && <img src={storeLogo} style={{ height: 50, marginTop: 6, borderRadius: 8 }} />}
          </div>
        </div>
