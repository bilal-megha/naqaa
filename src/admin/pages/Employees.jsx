...
const ALL_PERMISSIONS = [
  ...
  { id: 'orders',       label: '🛒 الطلبات',      actions: ['view','edit','delete'] },
  { id: 'customers',    label: '👥 العملاء',       actions: ['view','add','edit','delete'] },
  { id: 'inventory',    label: '🏭 المخزون',       actions: ['view','edit'] },
  { id: 'promotions',   label: '🎯 العروض',        actions: ['view','add','edit','delete'] },
  { id: 'reports',      label: '📊 التقارير',      actions: ['view'] },
  { id: 'employees',    label: '👔 الموظفون',      actions: ['view','add','edit','delete'] },
  { id: 'suppliers',    label: '🚚 الموردون',      actions: ['view','add','edit','delete'] },
  { id: 'expenses',     label: '💰 المصاريف',      actions: ['view','add','edit','delete'] },
  { id: 'settings',     label: '⚙️ الإعدادات',     actions: ['view','edit'] },
  { id: 'activityLog',  label: '📋 سجل النشاط',   actions: ['view'] },
  { id: 'backup',       label: '💾 النسخ الاحتياطي', actions: ['view','edit'] },
