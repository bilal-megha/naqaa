...
export default function PromotionsManager() {
  ...
  const { paged: pagedPromos, PagerUI: PromosPager } = usePagination(items, 10)
    ...
    <div>
      ...
      <div style={S.card}>
        ...
        <div style={{ marginTop: 12 }}>
          ...
          {form.image && (
            <LazyImage src={form.image} width={44} height={44} radius={8} fallback="📦" />
          )}
        </div>
                ...
                .map((p, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      {p.image ? (
                        <LazyImage src={p.image} width={44} height={44} radius={8} fallback="📦" />
                      ) : (
                        <div
                          style={{
                            width: 38,
