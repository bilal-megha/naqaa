 ...
 * @description إدارة المصاريف (إيجار، رواتب، فواتير، أخرى)
 */
...
const CAT_LABEL = { rent: 'إيجار', salary: 'رواتب', utilities: 'فواتير', other: 'أخرى' }
const EMPTY_FORM = { name: '', amount: '', date: new Date().toISOString().split('T')[0], category: 'other' }
            ...
            <tbody>
              {filtered.map(e => (
                <tr key={e.id} className="nq-tr">
                  ...
                  <td style={S.td}>{CAT_LABEL[e.category] || e.category}</td>
