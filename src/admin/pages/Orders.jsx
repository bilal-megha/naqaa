...
export default function Orders() {
  ...
  const { paged: pagedOrders, PagerUI } = usePagination(filtered, 20)
        ...
        <div style={S.card}>
          <div style={{overflowX:'auto'}}>
            <table style={{width:'100%',borderCollapse:'collapse'}}>
              <thead><tr>
                <th style={S.th}><input type="checkbox" onChange={e=>setSelectedOrders(e.target.checked?pagedOrders.map(o=>o.id):[])}/></th>
