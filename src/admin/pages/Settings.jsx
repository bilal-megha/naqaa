 ...
 * @description إعدادات المتجر العامة، الفروع، وتصنيف العملاء
 */
import { useState, useEffect } from 'react'
import { supabase } from '../../lib/supabase.js'
import { CLR, S, WA_DEFAULT } from '../constants.js'
import { logActivity } from '../utils.js'
import { NumInput, PhoneInput } from '../components/FormControls.jsx'

const DEFAULT_FORM = {
  store_name: 'نقاء', store_currency: 'دج',
  whatsapp_number: WA_DEFAULT, admin_phone: WA_DEFAULT, contact_whatsapp: WA_DEFAULT,
  ...
  terms_text: '', announce_bar: '', contact_hours: 'من 8 صباحاً إلى 10 مساءً',
