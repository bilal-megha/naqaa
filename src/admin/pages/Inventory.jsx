 ...
 * @description إدارة المخزون مع تصدير/استيراد Excel وتنبيهات واتساب
 */
import { useState, useEffect } from 'react'
import { supabase } from '../../lib/supabase.js'
import { CLR, S, CUR, WA_DEFAULT } from '../constants.js'
import { logActivity, printA4 } from '../utils.js'
        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead><tr>
              ...
              <th style={S.th}>الحالة</th><th style={S.th}>القيمة</th>
            </tr></thead>
            <tbody>
              {filtered.map(p => (
